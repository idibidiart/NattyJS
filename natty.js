 ...
 * or the Node's entire content, i.e. the virgin innerHTML or all instances of
 * the Node Prototype at once) where the Node can be dynamically linked into
 * other Nodes (from inside the Node Prototype), which can be linked into other 
 * Nodes, and so on...
 * 
 * Examples: 
 *
